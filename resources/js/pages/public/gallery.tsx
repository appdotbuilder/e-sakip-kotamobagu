...
export default function Gallery({ galleries, agencies, filters }: Props) {
    return (
        <>
            <Head title="Gallery - E-SAKIP Kotamobagu" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 mb-4">
                            📸 Gallery Kegiatan SAKIP
                        </h1>
                        <p className="text-lg text-gray-600">
                            Dokumentasi kegiatan SAKIP di Kota Kotamobagu
                        </p>
                    </div>

                    <div className="text-center text-gray-500 py-16">
                        <div className="text-6xl mb-4">📸</div>
                        <p>Gallery kegiatan akan tersedia segera</p>
                        <p className="text-sm mt-2">
                            Filters: {JSON.stringify(filters)}, Agencies: {agencies.length}, 
                            Gallery items: {galleries.data.length}
                        </p>
                    </div>
                </div>
            </div>
